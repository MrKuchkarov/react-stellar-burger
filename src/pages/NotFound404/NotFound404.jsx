        ...
        <section className={`${style["bg-purple"]}`}>
            ...
            <div className={`${style["stars"]}`}>
                ...
                <div className={`${style["central-body"]}`}>
                    <p className={`${style["page-404-title"]} text text_type_digits-large`}>
                        404
                    </p>
                    <p className={`${style["page-404"]} text text_type_main-large`}>
                        В этой галактике такая страница не существует!
                    </p>
                    {/*<img*/}
